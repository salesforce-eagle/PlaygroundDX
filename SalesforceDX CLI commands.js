  ...
  force:package1:version:list         # list package versions for the specifiedfirst-generation package or for the org
  ...
  force:source:pull                   # pull source from the scratch org to theproject
